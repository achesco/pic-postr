...
function preprocessPost(config, post) {
    ...
    return vow.all(promises).then(function (values) {
        ...
        ['date', 'tweet', 'link', 'slug'].forEach(function (field) {
            updatePostField(post, field);
        });
...
module.exports = {
    ...
    /**
     * Forms and returns full post object for given file
    ...
    getPost: function (fileName) {
        ...
        return preprocessPost(config, post);
    },
