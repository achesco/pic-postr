...
module.exports = {
    ...
    init: function (basePath, appConfig) {
        ...
        appConfig = _.merge({}, defaults, appConfig);
        logr.setLevel(appConfig.logLevel);
            ...
            promise
                .then(function (folderName) {
                    ...
                    postr.setup({
                        ...
                        imConvertPath: appConfig.imConvertPath,
                        config: config
                    });
                    ...
                    return postr.connect()
                        .always(function (promise) {
                            ...
                            if (promise.isRejected()) {
                                return vow.reject(
                                    new Err(
                                        folderName + ': authenitcation failed' + (value ? ': ' + String(value) : '')
                                    )
                                );
                            }
